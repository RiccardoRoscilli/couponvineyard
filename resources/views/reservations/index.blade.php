...
@section('content')
    ...
    <div class="container mt-5">
        ...
        @endif
        <a href="{{ route('coupon.export', ['status' => 'In Attesa']) }}" class="btn btn-success mb-3"><i class="fas fa-file-excel"></i> Esporta Excel</a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.yajra-datatable').DataTable({
                ...
                serverSide: true,
                pageLength: 50,
                order: [[8, 'desc']], // 8 è l'indice della colonna 'data_fattura'
                ajax: {
                    url: "{{ route('getreservationswaiting') }}",
                    data: function(d) {
        ...
        function populateModalWithData(id) {
            ...
            $.ajax({
                url: '/api/getIpraticoClientData/' + id,
                method: 'GET',
